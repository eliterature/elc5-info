...
জমা গ্রহণ: ১৩ অক্টোবর, ২০২৫ \- ৬ জানুয়ারী, ২০২৬
...
আমাদের এর আগের ELC এর প্রথম, দ্বিতীয়,তৃতীয় ও চতুর্থ ভাগে বিভিন্ন রকমের E.Lit এর উদাহরণ দেখা যাবে। আগের সংকলনগুলোর মতো এবারও আমরা সংরক্ষণ ও ডকুমেন্টেশনের প্রতি আগ্রহী, বিশেেষ করে সেই কাজগুলোর প্রতি যা সাহিত্যের প্রথাকে প্রশ্ন করে।
...
1. যেসব শিল্পী এখনও E-Lit সংগ্রহে প্রকাশিত হননি।

2. যেসব সম্প্রদায় E-Lit এ নবজাতক অথবা মধ্যপ্রাচ্য, উত্তর আফ্রিকা, আদিম অধিবাসী এবং এশিয়ার  বিভিন্ন দ্বীপপুঞ্জের সংস্কৃতিকে তুলে ধরে যে শিল্পীরা।

3. যেসব শিক্ষার্থী ও শিল্পীরা তাদের নিজেদের E-Lit নিজেরা তৈরী করেছেন। 

4. অন্যান্য গোষ্ঠী, সমিতি বা  ল্যাব যারা ডিজিটাল বা ইলেকট্রনিক মাধ্যমে লেখা বা সাহিত্য চর্চা করার চেষ্টা করেছেন।
...
ডিজিটাল লেখনীর সম্ভাব্য ক্ষমতা ও কার্যকারিতা একটি ডিজিটাল ভিডিওর মাধ্যমে জমা দিতে হবে। ভিডিও ফাইলেে রেশোলিউশন কমপক্ষে ... resolution er এবং ফাইল সাইজ 5 GB পর্যন্ত অনুমতি। যে ক্ষেত্রে ট্রাভারসাল পারফরম্যান্স বা অন্য রকমের প্রদর্শন সম্ভব নয়, সেখানে আমরা তা মৌলিক সারাংশ বিশিষ্ট ও নান্দনিকতার সম্পূর্ণ ডকুমেন্টেশন চাইছি। XR কাজের জন্য এর মধ্যে প্রতিনিধিত্বমূলক উপাদান এবং কাজের মূল দিকগুলির সাথে একটি অধিবেশনের রেকর্ডিং অন্তর্ভুক্ত থাকতে পারে, এবং কাজের ট্রেলার হিসাবে সেটা কাজ করবেনা।

### আপনার কাজ কীভাবে জমা দেবেন

দয়া করে নিম্নলিখিতগুলি জমা দেওয়ার জন্য প্রস্তুত থাকুন।

1. যদি মূল ফাইলটি ১ জিবির কম হয়, তাহলে একটি জিপ ফাইল, অথবা Itch.io, ওয়েব হোস্টিং, গুগল ড্রাইভ, অথবা ড্রপবক্সের লিঙ্ক, যদি বড় হয়।

2. লেখকের কাজের জন্য উপযুক্ত মেটাডেটা, যার মধ্যে রয়েছে তাদের নাম, শিরোনাম, তাদের কাজের জন্য প্রয়োজনীয় অ্যাক্সেসিবিলিটি বিকল্পগুলির বিবরণ।

3. **ঐচ্ছিক**: একটি ট্র্যাভার্সাল বা ডকুমেন্টেশন রেকর্ডিং যা কাজের বৈশিষ্ট্য এবং এর নান্দনিক তথ্য বর্ণনা করে, যদি কাজটি সহজে অ্যাক্সেসযোগ্য বা ব্যবহারযোগ্য না হয়।

4. শিল্পী/লেখকের একটি সংক্ষিপ্ত বিবৃতি, যার মধ্যে যেকোনো প্রাসঙ্গিক বিষয়বস্তু সতর্কতা সহ ২০০ শব্দের বেশি নয়।
